...
exports.completeProject = async (req, res) => {
  try {
    ...
    await User.findByIdAndUpdate(project.freelancer, {
      $inc: { completedProjects: 1, totalEarnings: project.payment.freelancerEarnings }
    });
...
exports.submitReview = async (req, res) => {
  try {
    ...
    if (project.client.toString() === req.user.id) {
      ...
      const newTotal = (freelancer.rating.average * freelancer.rating.count) + rating;
      ...
      project.review.freelancerReview = { rating, comment, createdAt: new Date() };
